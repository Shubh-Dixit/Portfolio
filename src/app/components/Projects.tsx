      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-12">
          {projects.map((project, index) => (
            <div
              key={index}
              className="group relative flex flex-col p-8 bg-card border border-border rounded-2xl hover:border-[#6366f1]/50 transition-all duration-300 hover:shadow-2xl hover:shadow-[#6366f1]/10 overflow-hidden"
            >
              {/* Gradient overlay */}
